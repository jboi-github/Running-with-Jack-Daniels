...
enum Plan {
    ...
    public static func planWeek(phase: Int, goal: Goal, sumTime: TimeInterval, days: Int, maxQdays: Int)
    ...
    public static func nextBestWorkout(
    ...
    public struct WorkoutStep {
        ...
        public let intensity: Run.Intensity
    ...
    public struct Workout {
        ...
        public let purpose: Run.Intensity
        public let steps: [WorkoutStep]
        public let totals: [Run.Intensity : TimeInterval]
